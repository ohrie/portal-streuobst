export default function DatenschutzPage() {
  return (
    <div className="bg-background">
      {/* Content */}
      <div className="py-20">
        <h1 className="text-4xl font-bold mb-8 text-primary font-heading text-center">
          Datenschutzerklärung
        </h1>

        <div className="prose prose-lg max-w-4xl mx-auto text-foreground">
          <span className="block mb-6 text-sm">Stand: 2. März 2026</span>

          <h2 className="text-2xl font-bold mb-4 text-secondary font-heading">
            1. Datenschutz auf einen Blick
          </h2>

          <h3 className="text-xl font-bold mb-3 text-tertiary font-heading">
            Allgemeine Hinweise
          </h3>
          <p className="mb-6">
          ...
          <h4 className="text-lg font-bold mb-3 text-tertiary font-heading">
          ...
          <p className="mb-6">
            ...
            (nachfolgend &bdquo;IONOS&ldquo;). Wenn Sie unsere Website besuchen,
            erfasst IONOS verschiedene Logfiles inklusive Ihrer IP-Adressen.
          </p>
          <p className="mb-6">
          ...
          <p className="mb-6">E-Mail: hallo@portal-streuobst.de</p>
          <p className="mb-6">
          ...
          <p className="mb-6">
            ...
            Website &ndash; hierzu müssen die Server-Log-Files erfasst werden.
          </p>
          ...
          <p className="mb-6">
            Diese Website verwendet Umami, ein datenschutzfreundliches
            Webanalyse-Tool. Umami wird auf einem eigenen Server des
            Websitebetreibers betrieben; es werden keine Daten an Dritte
            weitergegeben.
          </p>
          <p className="mb-6">
            Umami setzt <strong>keine Cookies</strong> und erstellt keine
            individuellen Nutzerprofile. Es werden ausschließlich anonymisierte,
            aggregierte Nutzungsstatistiken erhoben (z.&nbsp;B. aufgerufene
            Seiten, verwendeter Browser, Land des Zugriffs). IP-Adressen werden
            dabei <strong>vollständig anonymisiert</strong> und nicht
            gespeichert; eine Identifikation einzelner Personen ist nicht
            möglich.
          </p>
          <p className="mb-6">
            Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
            DSGVO. Unser berechtigtes Interesse besteht in der statistischen
            Auswertung des Nutzerverhaltens zur Verbesserung unseres
            Webangebots. Da keine personenbezogenen Daten dauerhaft gespeichert
            werden und kein Tracking einzelner Personen stattfindet, ist eine
          ...
          <p className="mb-6">
            Für die interaktive Karte auf dieser Website nutzen wir den Dienst
            Mapbox. Anbieter ist die Mapbox, Inc., 740 15th Street NW, Suite
            500, Washington, DC 20005, USA (nachfolgend &bdquo;Mapbox&ldquo;).
          </p>
          <p className="mb-6">
            Wenn Sie die Kartenseite aufrufen, stellt Ihr Browser eine
            Verbindung zu den Servern von Mapbox her, um Kartenkacheln und
            weitere Ressourcen zu laden. Dabei werden technische Daten wie Ihre
            IP-Adresse sowie Informationen zu den angezeigten Kartenausschnitten
            an Mapbox übermittelt.
          </p>
          <p className="mb-6">
            Mapbox, Inc. sitzt in den USA. Die Datenübermittlung in die USA
            erfolgt auf Grundlage der Standardvertragsklauseln (SCC) der
            Europäischen Kommission gemäß Art. 46 Abs. 2 lit. c DSGVO.
          </p>
          <p className="mb-6">
            Die Nutzung von Mapbox erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
            f DSGVO. Wir haben ein berechtigtes Interesse daran, unsere Karte
            mit einer leistungsfähigen und zuverlässigen Kartendarstellung zu
            betreiben.
          </p>
          <p className="mb-6">
          ...
          <h3 className="text-xl font-bold mb-3 text-tertiary font-heading">
            Photon by Komoot (Ortsuche)
          </h3>
          <p className="mb-6">
            Für die Ortsuche in der interaktiven Karte verwenden wir die
            Geocoding-API &bdquo;Photon&ldquo;, einen Dienst der Komoot GmbH,
            Stralauer Platz 34, 10243 Berlin (nachfolgend &bdquo;Komoot&ldquo;).
          </p>
          <p className="mb-6">
            Wenn Sie die Suchfunktion nutzen, werden Ihre Sucheingaben an Server
            von Komoot übermittelt, um passende Ortsvorschläge zu liefern. Dabei
            wird Ihre IP-Adresse an Komoot übertragen. Die Datenverarbeitung
            findet auf Servern innerhalb der Europäischen Union statt.
          </p>
          <p className="mb-6">
            Die Nutzung von Photon erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
            f DSGVO. Wir haben ein berechtigtes Interesse daran, Ihnen eine
            komfortable Suchfunktion zur Verfügung zu stellen. Die Suchanfragen
            werden ausschließlich zur Ausführung Ihrer Suche verwendet und nicht
            dauerhaft gespeichert.
          </p>
          <p className="mb-6">
            Weitere Informationen zum Datenschutz bei Komoot finden Sie unter:{" "}
            <a
              href="https://www.komoot.com/privacy"
              target="_blank"
              rel="noopener noreferrer"
              className="text-accent hover:text-accent-hover"
            >
          ...
          <p className="mt-10">
            Quelle der Datenschutzerklärung mit Anpassungen:{" "}

    ...
    <div className="bg-background">
      ...
      <Section className="pt-20 pb-8 px-4 text-center flex flex-col items-center justify-center">
        ...
        <p className="text-xl md:text-2xl text-foreground mb-6 max-w-4xl mx-auto leading-relaxed">
          Hilf mit eine umfassende Karte aller Streuobstwiesen in Deutschland zu
          erstellen. Damit der Impact dieser Biotope sichtbar wird. Dafür nutzen
          wir OpenStreetMap, das Wikipedia der Karten.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-left">
              <h2 className="text-lg font-bold text-foreground mb-2">
                Warum ist deine Hilfe wichtig?
              </h2>
              <p className="text-foreground leading-relaxed">
                Aktuell ist{" "}
                <strong>
                  nicht bekannt, wie viele Quadratmeter Streuobstwiesen es in
                  Deutschland gibt
                </strong>
                . Durch deine Kartierung in OpenStreetMap hilfst du, diese
                wichtige Datenbasis zu schaffen – für Naturschutz, Forschung und
                Förderpolitik. Lerne hier, wie du selbst Streuobstwiesen
                kartieren und zu diesem Projekt beitragen kannst.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bento-grid">
          <BentoCard icon={Database} title="OpenStreetMap als Basis">
            <p className="text-foreground mb-4">
              Alle Streuobstwiesen-Daten stammen aus OpenStreetMap (OSM), der
              freien Wiki-Weltkarte. OSM wird von Millionen von Freiwilligen
              weltweit gepflegt und ist frei verfügbar.
            </p>
            <p className="text-foreground">
              Die Daten werden regelmäßig automatisch aktualisiert und in unsere
              Karte importiert.
            </p>
          </BentoCard>
          ...
          <BentoCard icon={Map} title="Streuobstwiesen taggen">
            <p className="text-foreground mb-4">
              In OpenStreetMap werden Streuobstwiesen mit spezifischen Tags
              markiert:
            </p>
            <ul className="text-foreground text-left space-y-2 mb-4">
              ...
              <li>
                ...
                - spezifiziert es als Streuobstwiese
              </li>
              <li>
                •{" "}
                <code className="bg-background px-1 rounded">
                ...
                - optionale Baumart-Angabe
              </li>
            </ul>
            <p className="text-foreground mb-4">
              <strong>Wichtig:</strong> Ohne das Tag{" "}
              <code className="bg-background px-1 rounded">
                orchard=meadow_orchard
              </code>{" "}
              wird ein Obstgarten nicht als Streuobstwiese erkannt! Mehr Infos
              im{" "}
              <a
                href="https://wiki.openstreetmap.org/wiki/Tag:orchard%3Dmeadow_orchard"
                target="_blank"
            ...
            <p className="text-foreground mb-4">
              Darüber hinaus können auch einzelne Bäume getaggt werden, um die
              Genauigkeit noch zu erhöhen.
            </p>
          </BentoCard>
        </div>
      </Section>
      ...
      <Section className="py-20 px-4 text-center flex flex-col items-center justify-center">
        ...
        <p className="text-xl text-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
          Jeder kann zu OpenStreetMap beitragen. Beginne heute und hilf dabei,
          die Karte der Streuobstwiesen zu vervollständigen.
        </p>

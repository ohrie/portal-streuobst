...
const accordionData: AccordionItem[] = [
  {
    ...
    icon: Heart,
    description:
      "Du hast eine Wiese geerbt und weißt nicht, was du damit anfangen sollst?",
    content: {
      situation:
        "Eine geerbte Streuobstwiese kann zunächst überwältigend wirken, besonders wenn du keine Erfahrung mit der Bewirtschaftung hast. Viele Erben stehen vor der Frage: Selbst bewirtschaften, verkaufen oder verpachten?",
      solutions: [
  ...
  },
  {
    ...
    icon: TreePine,
    description:
      "Du willst lernen, wie du deine Streuobstwiese richtig pflegst und bewirtschaftest?",
    content: {
      situation:
        "Die Selbstbewirtschaftung einer Streuobstwiese ist eine wunderbare, aber auch anspruchsvolle Aufgabe. Sie erfordert Grundkenntnisse in Obstbaumpflege, Wiesenbewirtschaftung und jahreszeitlicher Planung.",
      solutions: [
  ...
  },
  {
    ...
    content: {
      situation:
        "Nicht jeder hat die Zeit, das Wissen oder die körperlichen Möglichkeiten, eine Streuobstwiese zu bewirtschaften. Verkauf oder Verpachtung können sinnvolle Alternativen sein.",
      solutions: [
      ...
      resources: [
        {
          title: "Streuobstwiesen-Börse",
          link: "https://www.streuobstwiesen-boerse.de/",
        },
      ],
    },
  },
  {
    ...
    icon: Users,
    description:
      "Du willst deine Wiese der Gemeinschaft zur Verfügung stellen?",
    content: {
      situation:
        "Manche Wiesenbesitzer möchten ihre Streuobstwiese für Bildungszwecke, Gemeinschaftsprojekte oder einfach zur gemeinsamen Nutzung öffnen. In der Gemeinschaft kann das gut klappen, erfordert aber gute Planung.",
      solutions: [
  ...
  },
  {
    ...
    content: {
      situation:
        "Die Bewirtschaftung von Streuobstwiesen wird oft gefördert, da sie wichtige ökologische und kulturelle Funktionen erfüllen. Es gibt verschiedene Förderprogramme auf Bundes- und Landesebene.",
      solutions: [
        ...
        <Section className="py-16 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Du hast eine Streuobstwiese geerbt, gekauft oder möchtest eine
              bewirtschaften? Hier findest du Antworten auf die häufigsten
              Fragen und praktische Hilfestellungen für verschiedene
              Situationen. Streuobstwiesen werden am besten erhalten, wenn sie
              genutzt werden: &laquo;Erhaltung durch Nutzung&raquo;.
            </p>
          </div>
        </Section>
            ...
            <div className="bg-light rounded-lg p-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {bundesweiteResources.map((res, idx) => (
                  <div
                    key={idx}
                    className="bg-white rounded-md p-4 border border-gray-200 flex flex-col justify-between h-full"
                  >
                    <div>
                      <a
                        href={res.link}
                        ...
                        className="text-sm font-semibold text-[var(--color-foreground)] hover:underline"
                      >
                        {res.title}
                      </a>
                      {res.description && (

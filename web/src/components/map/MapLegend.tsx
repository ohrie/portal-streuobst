      ...
      <div className="space-y-6">
        ...
        <div className="border-t pt-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Gemeinsam kartieren wir alle Streuobstwiesen in Deutschland – um
            erstmals zu ermitteln, wie viele Quadratmeter dieser wertvollen
            Biotope existieren. Alle Daten stammen aus{" "}
            <strong>OpenStreetMap</strong> und können von jede:r ergänzt werden.{" "}
            <strong>
              Die Daten sind nicht vollständig und können Fehler enthalten.
            </strong>
          </p>

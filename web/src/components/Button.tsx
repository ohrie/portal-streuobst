...
export default function Button({
  ...
  let finalClasses =
    "inline-flex items-center justify-center gap-2 font-semibold rounded-md shadow-sm transition-colors focus-visible:outline-2 focus-visible:outline-offset-2";
